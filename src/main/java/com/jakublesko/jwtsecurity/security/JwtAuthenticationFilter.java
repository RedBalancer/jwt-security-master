 ...
 * It’ll check for username and password parameters from URL and calls
 * Spring’s authentication manager to verify them.
 * <p>
 * If username and password are correct, then the filter will create
